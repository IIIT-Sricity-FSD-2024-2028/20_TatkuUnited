...
AppStore.ready.then(() => {
  ...
  const categories = [
    ...
    },
    {
      ...
      bg: "#f0fdfa",
      stroke: "#0d9488",
      path: `<path d="M12 2a5 5 0 015 5v3H7V7a5 5 0 015-5z"/><rect x="7" y="10" width="10" height="12" rx="2"/>`,
    },
    {
      name: "AC Repair",
      service: "SVC009",
      bg: "#fef3c7",
      stroke: "#f59e0b",
      path: `<rect x="2" y="7" width="20" height="10" rx="2"/><path d="M6 7V5M12 7V3M18 7V5M6 17v2M12 17v4M18 17v2"/>`,
    },
    {
      name: "Carpentry",
      service: "SVC007",
    ...
    },
    {
      ...
      bg: "#f0fdfa",
      stroke: "#0d9488",
      path: `<path d="M2 13.5V20h6.5L20 8.5 15.5 4 2 13.5z"/><path d="M21.5 5.5a2.12 2.12 0 00-3-3L15.5 4l3.5 3.5 2.5-2z"/>`,
    },
  ];
